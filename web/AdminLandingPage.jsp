...
uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> <% Boolean role =
(Boolean) session.getAttribute("role"); if (role == null || !role) {
                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-lg custom_nav-container">
                            <a class="navbar-brand" href="LandingPage.jsp"
                               ><img width="300" src="images/logofixfinal.png" alt="#"
                                  /></a>
                            <button
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="ManageBlog">View Community</a></li>    
                                            <li><a href="AdminBlog">Manage Community</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-lg-6">
                                            <div class="detail-box">
                                                ...
                                                <p>
                                                    Are you often worried about making spelling and grammar
                                                    mistakes in your writing? Let us help you! With our
                                                    advanced spelling and grammar check website, you no
                                                    longer have to worry about those minor errors.
                                                </p>
                                                <div class="btn-box">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-lg-6">
                                            <div class="detail-box">
                                                ...
                                                <p>
                                                    and grammar mistakes diminish a good impression. Our
                                                    spelling and grammar check website uses advanced AI
                                                    technology to help you detect and correct errors
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-lg-6">
                                            <div class="detail-box">
                                                ...
                                                <p>
                                                    essays, work emails, or social media posts, our tool is
                                                    always ready to assist, ensuring that every word you use
                                                    is accurate and professional. Try it today and see the
                                                    difference!
                                                </p>
                                                <div class="btn-box">
                                                    <a href="" class="btn1">Sign up now!</a>
