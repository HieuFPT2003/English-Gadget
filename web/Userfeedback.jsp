    ...
    <div class="feedback-list">
        ...
        <div class="pagination">
            <c:if test="${currentPage > 1}">
                <a href="userfeedback?page=${currentPage - 1}&limit=${limit}&sortBy=${sortBy}&order=${order}&keyword=${keyword}">Previous</a>
            </c:if>
            ...
            <c:forEach var="i" begin="${beginPage}" end="${endPage}">
                <a href="userfeedback?page=${i}&limit=${limit}&sortBy=${sortBy}&order=${order}&keyword=${keyword}" class="${i == currentPage ? 'active' : ''}">${i}</a>
            </c:forEach>

            <c:if test="${currentPage < totalPages}">
                <a href="userfeedback?page=${currentPage + 1}&limit=${limit}&sortBy=${sortBy}&order=${order}&keyword=${keyword}">Next</a>
            </c:if>
        </div>
    </div>
</div>
