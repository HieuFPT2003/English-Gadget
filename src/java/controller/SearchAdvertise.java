 ...
 * @author Admin
 */
@WebServlet(name = "SearchAdvertise", urlPatterns = {"/SearchAdvertise"})
public class SearchAdvertise extends HttpServlet {
...
//        processRequest(request, response);
        ...
        List<Advertise> ads = dao.searchAdsByTitle(title);
